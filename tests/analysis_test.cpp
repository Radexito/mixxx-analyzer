...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
                ...
                TrackParams{"LET'S GET FKD UP [hmdR9lacEkI].mp3",                                        106.7f, "6A"},
                TrackParams{"D-Frek - La La La (HTF REMIX) [-B4mYUbCoIA].mp3",                           100.2f, "11B"},
                TrackParams{"Spongebob [ufpvSvVRhnA].mp3",                                               100.0f, "6A"},
                TrackParams{"Prada [KYcSPar5uTk].mp3",                                                   142.0f, "4A"},
                TrackParams{"I Like To Move It [KpM9mpeLgtU].mp3",                                       150.0f, "5A"},
                TrackParams{"i like the way you kiss me [jVBsM8CM0AE].mp3",                              151.6f, "1A"},
                TrackParams{"Stolen Dance (Hypertechno Mix) [0rJaxjoTl_o].mp3",                          150.0f, "1A"},
                TrackParams{"L'Amour Toujours (Sped Up Hardstyle) [JKfX8-EeitE].mp3",                   169.1f, "6B"},
                ...
                TrackParams{"Calabria [Dj1TzBJcRec].mp3",                                                148.0f, "2A"},
                TrackParams{"Kernkraft 400 [xkQbISDpsjk].mp3",                                          150.0f, "10A"},
                TrackParams{"Tokyo Drift [ayNKqMoslU4].mp3",                                             150.0f, "6B"},
                ...
                TrackParams{"Give It To Me (Techno Edit) [7tTg4CuPWjU].mp3",                            150.1f, "1A"},
                TrackParams{"Phatt Bass (Blade) (feat. FEEZZ) [SuFiQH5nmi0].mp3",                       140.0f, "1A"},
                ...
                TrackParams{"Heroine [aZk3Apw0WH8].mp3",                                                144.0f, "8A"},
                TrackParams{"strangers tekkno [pIoJZQC9tUM].mp3",                                       160.0f, "11A"},
                TrackParams{"The Destroyer of All Things [lDcSBVRRwQ4].mp3",                            128.0f, "9A"},
                TrackParams{"D-Frek & DCX - Flying High [T2PqQH4Y0xI].mp3",                              92.5f, "4A"},
                ...
                TrackParams{"Blade [nEbbPM_Xl14].mp3",                                                  136.0f, "1A"},
                ...
                TrackParams{"Wanna Play\xef\xbc\x9f [9eRTxxTuUxo].mp3",                                 100.0f, "6A"},
                TrackParams{"La mort avec toi (Billx Remix) [P6yEhO4p8Jo].mp3",                         105.0f, "10A"},
                TrackParams{"Cover Up My Face [fld2XDSbK64].mp3",                                       155.0f, "7A"},
                TrackParams{"Le Bask & D-Frek - Six Names [0AfI5hjQB_0].mp3",                           195.0f, "7A"},
                ...
                TrackParams{"Walking On a Dream (Techno Remix) (feat. Zyzz) [EConX2hhuuY].mp3",         150.0f, "12A"},
                TrackParams{"Evil Sailor [Q_QdVLzolXI].mp3",                                            100.0f, "4A"},
                TrackParams{"Toccata [L0P8xj5jFn0].mp3",                                                140.0f, "7A"},
                TrackParams{"Hard Techno Is Not A Crime [0IzslPiJTM0].mp3",                             158.0f, "6A"},
                TrackParams{"Mexico [TaHup9LEBIk].mp3",                                                 105.0f, "6B"},
                TrackParams{"D-Frek & La Teigne - Party Crasher [z3P42pLGJ04].mp3",                     100.0f, "4A"},
